        ...
        */
        ...
        switch(selectCategory) {
            case this.state.subcategoriesArray[0]:
                tempProducts = tempProducts.filter(product => product.subcategory === this.state.subcategoriesArray[0]);
                itemsCount = tempProducts.length;
                break;
            case this.state.subcategoriesArray[1]:
                tempProducts = tempProducts.filter(product => product.subcategory === this.state.subcategoriesArray[1]);
                itemsCount = tempProducts.length;
                break;
            case this.state.subcategoriesArray[2]:
                tempProducts = tempProducts.filter(product => product.subcategory === this.state.subcategoriesArray[2]);
                itemsCount = tempProducts.length;
                break;
            case this.state.subcategoriesArray[3]:
                tempProducts = tempProducts.filter(product => product.subcategory === this.state.subcategoriesArray[3]);
                itemsCount = tempProducts.length;
                break;
            case this.state.subcategoriesArray[4]:
                tempProducts = tempProducts.filter(product => product.subcategory === this.state.subcategoriesArray[4]);
                itemsCount = tempProducts.length;
                break;
            case this.state.subcategoriesArray[5]:
                tempProducts = tempProducts.filter(product => product.subcategory === this.state.subcategoriesArray[5]);
                itemsCount = tempProducts.length;
                break;
            case this.state.subcategoriesArray[6]:
                tempProducts = tempProducts.filter(product => product.subcategory === this.state.subcategoriesArray[6]);
                itemsCount = tempProducts.length;
                break;
            case this.state.subcategoriesArray[7]:
                tempProducts = tempProducts.filter(product => product.subcategory === this.state.subcategoriesArray[7]);
                itemsCount = tempProducts.length;
                break;
            case this.state.subcategoriesArray[8]:
                tempProducts = tempProducts.filter(product => product.subcategory === this.state.subcategoriesArray[8]);
                itemsCount = tempProducts.length;
                break;
            case this.state.subcategoriesArray[9]:
                tempProducts = tempProducts.filter(product => product.subcategory === this.state.subcategoriesArray[9]);
                itemsCount = tempProducts.length;
                break;
            case this.state.subcategoriesArray[10]:
                tempProducts = tempProducts.filter(product => product.subcategory === this.state.subcategoriesArray[10]);
                itemsCount = tempProducts.length;
                break;
            case this.state.subcategoriesArray[11]:
                tempProducts = tempProducts.filter(product => product.subcategory === this.state.subcategoriesArray[11]);
                itemsCount = tempProducts.length;
                break;
            case this.state.subcategoriesArray[12]:
                tempProducts = tempProducts.filter(product => product.subcategory === this.state.subcategoriesArray[12]);
                itemsCount = tempProducts.length;
                break;
            case this.state.subcategoriesArray[13]:
                tempProducts = tempProducts.filter(product => product.subcategory === this.state.subcategoriesArray[13]);
                itemsCount = tempProducts.length;
                break;
        }
        /*
        ...
        */
        if (optionsSort !== 'all'){
            if(optionsSort === 'alphabetical'){
                ...
                tempProducts = tempProducts.sort((a, b) => (a.rating > b.rating) ? 1 : -1);
            }
        }
        /* 
            rubric29
   ...
   */
    ...
    */
    addTotals = () => {
        ...
        const total = parseFloat((subTotal + tax).toFixed(2)) + this.state.cartShipping;
        this.setState(() => {
            return {
